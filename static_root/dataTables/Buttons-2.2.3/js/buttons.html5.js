...
var _excelSpecials = [
	...
	{ match: /^[\d]{2}\-[\d]{2}\-[\d]{4}$/, style: 67, fmt: function (d) {return Math.round(25569 + (Date.parse(d.substring(6,10)+"-"+d.substring(3, 5)+"-"+d.substring(0, 2)) / (86400 * 1000)));}}//Date dd/mm/yyyy 
];
