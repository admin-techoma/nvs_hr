    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('married_status', models.CharField(choices=[('Married', 'Married'), ('Unmarried', 'Unmarried')], default='Unmarrid', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('department', models.ForeignKey(default='Select Designations', on_delete=django.db.models.deletion.CASCADE, related_name='designation', to='employee.department', verbose_name='department')),
            ],
        ),
    ]
