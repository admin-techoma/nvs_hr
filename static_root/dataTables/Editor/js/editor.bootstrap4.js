...
$.extend( true, $.fn.dataTable.Editor.classes, {
	...
	"form": {
		"tag": "form-horizontal",
		"button": "btn",
		"buttonInternal": "btn btn-outline-c_SSC"
	},
	"field": {
		"wrapper": "DTE_Field form-group row",
		"label":   "col-lg-4 col-form-label mb-0",
		"input":   "col-lg-8",
		"error":   "error is-invalid",
		"msg-labelInfo": "form-text text-c_SSC small",
		"msg-info":      "form-text text-c_SSC small",
		"msg-message":   "form-text text-c_SSC small",
