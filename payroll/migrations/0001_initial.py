    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monthly_ctc', models.FloatField(default=0, verbose_name='monthly_ctc')),
                ('monthly_basic', models.FloatField(default=0, verbose_name='monthly_basic')),
                ('monthly_hra', models.FloatField(default=0, verbose_name='monthly_hra')),
                ('monthly_ca', models.FloatField(default=0, verbose_name='monthly_ca')),
                ('monthly_sa', models.FloatField(default=0, verbose_name='monthly_sa')),
                ('monthly_employeepf', models.FloatField(default=0, verbose_name='monthly_employeepf')),
                ('monthly_employerpf', models.FloatField(default=0, verbose_name='monthly_employerpf')),
                ('monthly_employeeesic', models.FloatField(default=0, verbose_name='monthly_employeeesic')),
                ('monthly_employeresic', models.FloatField(default=0, verbose_name='monthly_employeresic')),
                ('monthly_gross_salary', models.FloatField(default=0, verbose_name='monthly_gross_salary')),
                ('monthly_newctc', models.FloatField(default=0, verbose_name='monthly_newctc')),
                ('monthly_professionalTax', models.FloatField(default=0, verbose_name='monthly_professionalTax')),
                ('monthly_total_deductions', models.FloatField(default=0, verbose_name='monthly_total_deductions')),
                ('monthly_netpay', models.FloatField(default=0, verbose_name='monthly_netpay')),
                ('monthly_netpayinwords', models.CharField(blank=True, max_length=250, null=True)),
                ('monthly_incentive', models.FloatField(default=0, verbose_name='monthly_incentive')),
                ('monthly_loan_other', models.FloatField(default=0, verbose_name='monthly_loan_other')),
